...
let birthMonth = monthArray[Math.floor(Math.random () * monthArray.length)];
//let birthMonth = "Auguste";
...
let fortuneMsg = fortuneArray[Math.floor(Math.random () * fortuneArray.length)];
...
} else { // Error check for month
  console.log("Not a valid month.")
}

// Prints out fortune
if (monthArray.includes(birthMonth) == true) {
	console.log(fortuneMsg);
} else { // Error check for month
	console.log("No fortune seen yet. Try again!");
}